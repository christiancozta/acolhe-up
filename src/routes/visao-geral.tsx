        ...
        <div className="border-t border-line py-1 md:border-t-0 md:pl-5">
          {data === null ? (
            ...
            demandas.map(([id, total], index) => (
              <div key={id} className="grid grid-cols-[30px_minmax(0,1fr)_minmax(90px,1.6fr)_34px] items-center gap-4 border-b border-line py-4 last:border-b-0 md:grid-cols-[30px_11rem_minmax(120px,1fr)_34px]">
